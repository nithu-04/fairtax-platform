...
def _check_pending_reminders():
    ...
    # logger.info(f"[REMOVED] Scheduler] Sent 3-day payment reminder to {phone}")
                    except Exception as e:
    # logger.info(f"[REMOVED] Scheduler] Failed to send reminder: {e}")

    except Exception as e:
    # logger.info(f"[REMOVED] Scheduler] Reminder check error: {e}")
...
def _check_referral_updates():
    ...
    # logger.info(f"[REMOVED] Scheduler] Sent referral update to {phone}: {rcount} referrals")

            except Exception as e:
    # logger.info(f"[REMOVED] Scheduler] Failed to send referral update: {e}")

    except Exception as e:
    # logger.info(f"[REMOVED] Scheduler] Referral update check error: {e}")
...
def _check_filing_completion():
    ...
    # logger.info(f"[REMOVED] Scheduler] Sent filing completion notification to {phone}")
                except Exception as e:
    # logger.info(f"[REMOVED] Scheduler] Failed to send filing notification: {e}")

    except Exception as e:
    # logger.info(f"[REMOVED] Scheduler] Filing completion check error: {e}")
...
def start_scheduler():
    ...
    scheduler.start()
    # logger.info(f"[REMOVED] "[Scheduler] ✅ Started with 3 automated tasks:")
    # logger.info(f"[REMOVED] "  • 3-day payment reminders (every 12h)")
    # logger.info(f"[REMOVED] "  • Referral status updates (every 24h)")
    # logger.info(f"[REMOVED] "  • Filing completion notifications (every 6h)")
    return scheduler
